...
const PaymentPageDenied = () => {
    return (
        <Grid container xs={12} alignItems={"center"} justifyContent={"center"} direction={"column"} py={paddings.topBottom64} gap={7}>
            ...
            <Grid md={8} lg={8} xl={8} sx={{ textAlign: 'center' }} mt={margins.top24}>
                <TextTypography16>
                    Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in
                    a piece of classical Latin literature from 45 BC, making it over 2000 years old.Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in
